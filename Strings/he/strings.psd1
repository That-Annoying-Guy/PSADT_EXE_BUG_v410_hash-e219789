    ...
    WelcomePrompt = @{
        Classic = @{
            Close = @{
                ...
                ButtonDefer = 'לִדחוֹת'
                CountdownMessage = 'הערה: התוכניות ייסגרו אוטומטית ב:'
                Message = @{
            ...
            Defer = @{
                ...
                RemainingDeferrals = 'דחיות שנותרו:'
                WarningMessage = 'לאחר שהדחיה פג, לא תהיה לך יותר אפשרות לדחות.'
                WelcomeMessage = @{
        ...
        Fluent = @{
            ...
            DialogMessageNoProcesses = @{
                Install = 'אנא בחר התקן כדי להמשיך בהתקנה. אם נותרו לך דחיות, תוכל גם לבחור לדחות את ההתקנה.'
                Repair = 'אנא בחר תיקון כדי להמשיך בתיקון. אם נותרו לך דחיות, תוכל גם לבחור לדחות את התיקון.'
                Uninstall = 'אנא בחר הסר כדי להמשיך בהסרת ההתקנה. אם נותרו לך דחיות, תוכל גם לבחור לדחות את הסרת ההתקנה.'
            }
